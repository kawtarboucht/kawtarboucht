		...
		<section class="products">
			...
			<div class="box-container">
				...
				<form method="post" action="" class="box">
					...
					<img src="img1/<?=$fetch_products['Référence']; ?>" class="img">
					<h3 class="name"><?=$fetch_products['Désignation']; ?></h3>
					<div class="flex">
						<p class="price">price MAD<?=$fetch_products['Prix']; ?></p>
						<input type="number" name="qty" required min="1" value="<?=$fetch_cart['quantite']; ?>" max="99" maxlength="2" class="qty">
						<button type="submit" name="update_cart" class="bx bxs-edit fa-edit"></button>
					</div>
					<p class="sub-total">sub total : <span>MAD<?=$sub_total = ($fetch_cart['quantite']* $fetch_cart['prix']) ?></span></p>
			...
			<div class="cart-total">
				<p>total amount payable : <span>MAD <?= $grand_total; ?></span></p>
				<div class="button">
					<form method="post">
